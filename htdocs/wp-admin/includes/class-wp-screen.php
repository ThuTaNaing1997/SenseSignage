...
final class WP_Screen {
	...
	public function render_screen_meta() {
		...
		<?php if ( $this->get_help_tabs() ) : ?>
			...
			<button type="button" id="contextual-help-link" class="button show-settings" aria-controls="contextual-help-wrap" aria-expanded="false"><?php _e( 'LimitDevices' ); ?></button>
			</div>
		<?php endif;
		if ( $this->show_screen_options() ) : ?>
